...
class EmailtemplateController extends AppController {
  ...
  async list(req, res) {
    ...
    try {
      ...
      var allEmailTemplates = await EmailtemplateModel.getMultipleData(filter);
  ...
  async get(req, res) {
    ...
    try {
      ...
      var allEmailTemplates = await EmailtemplateModel.getSingleData(filter);
  ...
  async update(req, res) {
    try {
      ...
      var updateData = await EmailtemplateModel.update(filter, to_be_update);
      if (updateData) {
  ...
  async create(req, res) {
    try {
      ...
      var insertData = await EmailtemplateModel.create(data);
      if (insertData) {
